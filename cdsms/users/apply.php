...
$query=mysqli_query($con,"insert into tblapplication(PackID,UserId,RegNumber,FullName,Email,MobileNumber,Gender,Age,Address,AlternateNumber,TrainingDate,TrainingTiming,TakenFor) value('$packages','$uid','$regnumber','$fullname','$email','$mobilenumber','$gender','$age','$address','$altnumber','$trainingdate','$time','$takenfor')");
if ($query) {
 ...
 <div class="form-group">
  ...
  <div class="col-lg-6">
     ...
     <div class="form-group">
        ...
        <input type="date" name="trainingdate" placeholder="Trainin Date" min="2023-02-03" required>
    </div>
                                        
<div class="form-group">
    <label for="street" class=" form-control-label">Training Time</label>
    <input type="time" id="time" name="time" placeholder="Trainin Date" min="10:00am"max="07:00pm"class="form-control" required>
</div>
</div>
